...
## Project Structure
    ...
    ├── testbackandforth_de_37833  # Django project configurations
...
1. Clone this repo and `cd testbackandforth_de_37833`
...
2. Clone this repo and `cd testbackandforth_de_37833`
